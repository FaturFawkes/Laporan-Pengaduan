    ...
    <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <div class="col-md-12 lg-12">
                            ...
                            <p>Ini adalah halaman utama untuk adminstrator. Disini sudah tersedia fitur-fitur untuk memudahkan masyarakat untuk melakukan penngaduan</p>
                            <hr>
                            <p class="mb-0">Fitur yang dapat anda gunakan adalah :
                            <br>1. Memvalidasi Laporan
                            <br>2. Memberikan Tanggapan untuk laporan
                            <br>3. Membuat (generate) laporan
                            <br>3. Verifikasi Akun Masyarakat
                            <br>4. Membuat akun petugas
                            </p>
                            </div>
                        </div>
                    </div>       
